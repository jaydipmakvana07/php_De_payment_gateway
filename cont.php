		...
		<ul class="side-menu top">
			<li >
				<a href="slider.php">
					...
					<span class="#" href="slider.html" >Dashboard</span>
				</a>
			</li>
			<li>
				<a href="mystore.html">
        ...
        <main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
                        ...
                        <li><i class='bx bx-chevron-right' ></i></li>
                        <li>
							<a class="active" href="#">To Contact</a>
            ...
            <div>
                ...
                <div class="box107"  style="margin: auto; margin-top: 50px;">
                        ...
                        <form action="amcont.php" method="POST" autocomplete="off" style="margin: auto; padding-top: 10px;">
                            <h3 class="title">Contact Details</h3><br>
                            <div class="input-container">
                            <input type="text"  name="name" class="input" />
                            <label for=""> Name</label>
                            <span> Name</span>
                            </div>
                            <h5   style="text-align: center; color: aliceblue;">OR</h5>
                            <div class="input-container">
