        ...
        <main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
                        ...
                        <li><i class='bx bx-chevron-right' ></i></li>
                        <li>
							<a class="active" href="upi01.php">UPI</a>
            ...
            <div>
                ...
                <div class="box111" style="margin: auto; margin-top: 150px;">
                        ...
                        <form action="up01.php" autocomplete="off" style="margin: auto; padding-top: 10px;">
                            <h3 class="title" style="text-align: center;">UPI Virtual ID</h3><br>
